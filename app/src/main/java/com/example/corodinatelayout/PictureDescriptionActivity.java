...
public class PictureDescriptionActivity extends AppCompatActivity {
    ...
    private int[] imgs ={
         R.drawable.fanchuan,R.drawable.flower5,R.drawable.flower5,R.drawable.flower5,R.drawable.gou,R.drawable.biao
            ,R.drawable.naicha,R.drawable.fanchuan,R.drawable.naicha,R.drawable.flower5,R.drawable.flower1,R.drawable.flower5
            ,R.drawable.logo,R.drawable.flower5,R.drawable.fanchuan,
    };
